...
If you want to know how to **change the capacity** of wallets and what the different **currency modes** do, check out our pages about the [Server Config](/docs/category/server-config).
